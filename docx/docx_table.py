...
name = "张三" # input('姓名：')
departments = "计算机系" # input('院系')
specialty = "人工智能" # input('专业')
class_name = "2103023" # input('班级：')
gender = "男" # input('性别：')
school_num = "210302303" # input('学号：')
school_time_year = "2020" # input('在校起始时间年')
school_time_month = "2" # input('在校起始时间月')
school_time_year1 = "2020" # input('在校截止时间年')
school_time_month1 = "3" # input('在校截止时间月')
home_address = "上海" # input('家庭通讯地址：')
personal_tel = "12345678" # input('个人联系方式：')
home_num = "123456789" # input('家庭联系方式：')
reason = "因新冠肺炎在家隔离" # input('本人申请理由：')
